    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Add Prime Minister details section</h4>
              <form action="{{route('addminister')}}"  method="post" enctype="multipart/form-data">
                @csrf
                <label for="cars">Choose Minister Type</label>
                        ...
                        <table id="selection-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img  class="img-thumbnail" style="width: 100px; height:100px" src="/upload/minister/{{$item->photo}}"></td>
                                    <td>
                                        <a href="{{"/edit/minister-details/".$item['id']}}" class="btn btn-info sm" title="edit Data"> <i class="fas fa-edit"></i></a>
                                        <a href="{{"/delete/minister-details/".$item['id']}}" class="btn btn-danger sm" title="Delete Data" id="delete"> <i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
