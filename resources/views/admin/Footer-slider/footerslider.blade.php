    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('footer.Addslider')}}"  method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <table id="selection-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img  class="img-thumbnail" style="width: 150px; height:60px" src="upload/footerslider/{{$item->footerslider}}">
                                    </td>
                                    <td>
                                        <a href="{{"/edit/footerslider/".$item['id']}}" class="btn btn-info sm " title="edit Data"> <i class="fas fa-edit"></i></a>
                                        <a href="{{"/delete/footerslider/".$item['id']}}" class="btn btn-danger sm" title="Delete Data" id="delete"> <i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
